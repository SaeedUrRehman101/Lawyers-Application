                    ...
                    <div class="tab-pane fade show active" id="wizard-info" role="tabpanel" aria-labelledby="wizard-info-tab">
                      <form class="row g-3 needs-validation" action="{{ route("lawyer_Details") }}" enctype="multipart/form-data" method="POST">
                        ...
                        <div class="col-xl-7 col-sm-6">
                          ...
                          @php
                              $user = Auth::guard('lawyers')->user();
                          @endphp
                          @isset($user)
                              <input class="form-control mb-3" name="name" value="{{ $user->lawyerName }}" id="customFirstname" type="text" placeholder="Enter first name">
                          @else
                        ...
                        <div class="col-6">
                          <label class="form-label" for="customDesignation">Designation<span class="txt-danger">*</span></label>
                        ...
                        <div class="col-xl-6 col-sm-6">
                          ...
                          <div class="col-xxl-9 box-col-12">
                            <div class="input-group flatpicker-calender">
                              @isset(Auth::guard('lawyers')->user()->dob)
                              <input class="form-control mb-3" name="dob" value="{{ old('dob', Auth::guard('lawyers')->user()->dob ?? '') }}" id="customDob" type="date" placeholder="Enter Date of Birth" required>
                              @else
                        ...
                        <div class="col-xl-6 col-sm-4">
                          ...
                          <select class="form-select mb-3" id="customState-wizard" required="" name="province">
                      ...
                      <form class="row g-3 needs-validation" action="{{ route("lawyer_Details") }}" enctype="multipart/form-data" method="POST">
                        ...
                        <div class="col-sm-6">
                          ...
                          <div class="card-wrapper checkbox-checked">
                            ...
                            {{ isset($lawyerAreas) && in_array('Instagram',$lawyerAreas) ? "checked" : '' }}
                            value="Instagram" type="checkbox">Instagram
                            <label class="d-block" for="chk-ani1"></label>
                            <input class="checkbox_animated" id="chk-ani1" name="areas[]"
                            {{ isset($lawyerAreas) && in_array('Facebook',$lawyerAreas) ? "checked" : '' }}
                            value="Facebook" type="checkbox">Facebook
                            <label class="d-block" for="chk-ani2"></label>
                            <input class="checkbox_animated" id="chk-ani2" name="areas[]" 
                            {{ isset($lawyerAreas) && in_array('Whatsapp',$lawyerAreas) ? "checked" : '' }}
                            value="Whatsapp" type="checkbox">Whatsapp
                            <label class="d-block" for="chk-ani4"></label>
                            <input class="checkbox_animated" id="chk-ani4" name="areas[]"
                            {{ isset($lawyerAreas) && in_array('Twitter',$lawyerAreas) ? "checked" : '' }}
                            value="Twitter" type="checkbox">Twitter  
                          </div>
                          @error("areas")
                          <small id="helpId" class="form-text text-danger bg-danger-subtle w-25 pe-4 ps-3 pb-2 pt-2 rounded-3">{{ $message }}</small>
                          @enderror
